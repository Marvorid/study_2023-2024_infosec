...
1. Создаем новую виртуальную машину. (рис. [-@fig:001]).

![Создание виртуальной машины](image/1.png){#fig:001 width=95%}


2. Установили Kali Linux. (рис. [-@fig:002]).

![Установка](image/2.png){#fig:002 width=95%}
